...
overlaps between reads. To produce this graph we need to find sufficiently long
overlaps between all reads. This often leads to algorithms which have quadratic
